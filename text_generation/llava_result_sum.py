import json
import argparse
parser = argparse.ArgumentParser(description='Generate a json file of image-text pair')
parser.add_argument('--text_dir',type=str, default='data/imagewoof',
                        help='text dir')
...
data1 = list(read_json_objects(f'{args.text_dir}/answer-file.json'))
...
output_file = f'{args.text_dir}/metadata.jsonl'
with open(output_file, 'w', encoding='utf-8') as out_f:
    with open(f'{args.text_dir}/rename.sh','w') as f2: 
